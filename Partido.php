...
public function __toString(){
    ...
    //Punto 5
    public function coeficientePartido($objEquipo1, $objEquipo2){
        $base = $this->getCoefBase();
        $cantJugadoresE1 = $objEquipo1->getCantJugadores();
        $canntJugadoresE2 = $objEquipo2->getCantJugadores();
        $base = $base * ($this->getCantGolesE1() + $this->getCantGolesE2()) * ($cantJugadoresE1 + $canntJugadoresE2);
        return $base;
    }
